...
import com.example.bcareapplication.adapter.SalonItemSliderAdapter;
...
import com.example.bcareapplication.data.model.api_model.salons.SalonImage;
...
public class SelectSalonAdapter extends RecyclerView.Adapter<SelectSalonAdapter.SelectSalonHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull SelectSalonHolder selectSalonHolder, int i) {
